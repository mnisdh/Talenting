...
public interface IMyTripApiService {
    ...
    @POST("/member/mytrip/")
    Observable<Response<Void>> create(@Header("Authorization") String token,@Body MyTrip mytrip);
    ...
    Observable<Response<Void>> delete(@Header("Authorization") String token, @Path("mytrip_pk")String pk);
